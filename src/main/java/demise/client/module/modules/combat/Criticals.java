...
import static demise.client.module.modules.rage.killAura.KillAuraAdditions.targetPriority;
...
public class Criticals extends Module {
    ...
    private static EntityLivingBase findTarget() {
        ...
        for (Entity entity : mc.theWorld.loadedEntityList) {
            ...
            if (entity instanceof EntityPlayer && entity != mc.thePlayer && !AimAssist.isAFriend(entity) && distanceToEntity <= range.getInput() + 0.337) {
